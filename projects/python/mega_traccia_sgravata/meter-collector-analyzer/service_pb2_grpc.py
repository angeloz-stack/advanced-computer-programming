...
class AnalyzerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.analyze = channel.stream_unary(
                '/Analyzer/analyze',
                request_serializer=service__pb2.Reading.SerializeToString,
                response_deserializer=service__pb2.StringMessage.FromString,
                _registered_method=True)
        self.get_stats = channel.unary_unary(
                '/Analyzer/get_stats',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.Stats.FromString,
                _registered_method=True)
...
def add_AnalyzerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'analyze': grpc.stream_unary_rpc_method_handler(
                    servicer.analyze,
                    request_deserializer=service__pb2.Reading.FromString,
                    response_serializer=service__pb2.StringMessage.SerializeToString,
            ),
            'get_stats': grpc.unary_unary_rpc_method_handler(
                    servicer.get_stats,
                    request_deserializer=service__pb2.Empty.FromString,
                    response_serializer=service__pb2.Stats.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Analyzer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Analyzer', rpc_method_handlers)
...
class Analyzer(object):
    ...
    def analyze(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/Analyzer/analyze',
            service__pb2.Reading.SerializeToString,
